...
def download_file(file_id, output):
    if not os.path.exists(output):  # عشان ميحملش الملف كل مرة
        url = f"https://drive.google.com/uc?id={file_id}"
        gdown.download(url, output, quiet=False)
download_file("1qbGSiiunABngnVaLXxEaMyHQfZ9EkCI2", "temperature_model.pkl")
download_file("1SLa-uPqQa3dpgRdbE31AKINMf_gkGyup", "rain_model.pkl")
download_file("1yh4r8GvLVbBuXQFP5chRmMs54QTW6EWH", "feature_cols_temp.pkl")
download_file("1onQIHHLegG15efI5TVhXH-Tg3K71oh8e", "feature_cols_rain.pkl")
# ------------------------
# Load models and features
# ------------------------
rfr = joblib.load("temperature_model.pkl")   # Regressor model
